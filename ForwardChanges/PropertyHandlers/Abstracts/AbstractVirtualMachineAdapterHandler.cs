...
{
    public abstract class AbstractVirtualMachineAdapterHandler<TRecordGetter, TRecord, TAdapterGetter, TAdapter> : AbstractListPropertyHandler<IScriptEntryGetter>
