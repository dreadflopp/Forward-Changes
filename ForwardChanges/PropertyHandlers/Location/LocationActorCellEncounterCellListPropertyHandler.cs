...
{
    public class LocationActorCellEncounterCellListPropertyHandler : AbstractListPropertyHandler<ILocationCoordinateGetter>
    {
        public override string PropertyName => "ActorCellEncounterCell";
        ...
        public override List<ILocationCoordinateGetter>? GetValue(IMajorRecordGetter record)
        {
            ...
            {
                return locationRecord.ActorCellEncounterCell?.ToList();
            }
        ...
        public override void SetValue(IMajorRecord record, List<ILocationCoordinateGetter>? value)
        {
            ...
            {
                if (locationRecord.ActorCellEncounterCell != null)
                {
                    locationRecord.ActorCellEncounterCell.Clear();
                    if (value != null)
                    {
                        foreach (var item in value)
                        {
                            ...
                            {
                                locationRecord.ActorCellEncounterCell.Add(castItem);
                            }
                        }
                    }
                }
