...
{
    public class RaceRegenHandler : AbstractPropertyHandler<IReadOnlyDictionary<BasicStat, float>>
    {
        public override string PropertyName => "Regen";
        ...
        public override void SetValue(IMajorRecord record, IReadOnlyDictionary<BasicStat, float>? value)
        {
            ...
            {
                raceRecord.Regen[kvp.Key] = kvp.Value;
            }
        }
