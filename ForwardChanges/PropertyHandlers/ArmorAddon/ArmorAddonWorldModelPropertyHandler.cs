...
{
    public class ArmorAddonWorldModelPropertyHandler : AbstractPropertyHandler<IGenderedItemGetter<IModelGetter?>>
    {
        ...
        public override void SetValue(IMajorRecord record, IGenderedItemGetter<IModelGetter?>? value)
        {
            if (record is IArmorAddon armorAddonRecord)
            {
                if (value == null)
                {
                    armorAddonRecord.WorldModel = null;
                }
                else
                {
                    ...
                    armorAddonRecord.WorldModel = newGenderedItem;
                }
            }
            else
            {
        ...
        public override IGenderedItemGetter<IModelGetter?>? GetValue(IMajorRecordGetter record)
        {
            ...
            {
                return armorAddonRecord.WorldModel;
            }
            else
            {
