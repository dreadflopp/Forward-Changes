...
namespace ForwardChanges.PropertyHandlers.TextureSet
{
    public class BacklightMaskOrSpecularHandler : AbstractPropertyHandler<AssetLinkGetter<SkyrimTextureAssetType>?>
    {
        ...
        public override void SetValue(IMajorRecord record, AssetLinkGetter<SkyrimTextureAssetType>? value)
        {
            ...
            if (tx != null)
                tx.BacklightMaskOrSpecular = value == null ? null : new AssetLink<SkyrimTextureAssetType>(ForwardChanges.PropertyHandlers.General.TexturePathHelper.Normalize(value));
        }
