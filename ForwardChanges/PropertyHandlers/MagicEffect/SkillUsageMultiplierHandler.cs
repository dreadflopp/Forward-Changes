...
{
    public class SkillUsageMultiplierHandler : AbstractPropertyHandler<float>
    {
        public override string PropertyName => "SkillUsageMultiplier";

        public override void SetValue(IMajorRecord record, float value)
        {
            if (record is IMagicEffect magicEffect)
            {
                magicEffect.SkillUsageMultiplier = value;
            }
            else
            {
        ...
        public override float GetValue(IMajorRecordGetter record)
        {
            ...
            {
                return magicEffect.SkillUsageMultiplier;
            }
            else
            {
