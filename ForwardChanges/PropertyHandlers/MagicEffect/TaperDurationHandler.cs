...
{
    public class TaperDurationHandler : AbstractPropertyHandler<float>
    {
        public override string PropertyName => "TaperDuration";

        public override void SetValue(IMajorRecord record, float value)
        {
            if (record is IMagicEffect magicEffect)
            {
                magicEffect.TaperDuration = value;
            }
            else
            {
        ...
        public override float GetValue(IMajorRecordGetter record)
        {
            ...
            {
                return magicEffect.TaperDuration;
            }
            else
            {
