...
{
    public class TaperWeightHandler : AbstractPropertyHandler<float>
    {
        public override string PropertyName => "TaperWeight";

        public override void SetValue(IMajorRecord record, float value)
        {
            if (record is IMagicEffect magicEffect)
            {
                magicEffect.TaperWeight = value;
            }
            else
            {
        ...
        public override float GetValue(IMajorRecordGetter record)
        {
            ...
            {
                return magicEffect.TaperWeight;
            }
            else
            {
