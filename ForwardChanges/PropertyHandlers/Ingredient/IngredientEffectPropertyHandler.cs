...
{
    public class IngredientEffectPropertyHandler : AbstractPropertyHandler<IReadOnlyList<IEffectGetter>>
    {
        ...
        {
            if (record is IIngredient ingredient)
            {
                var effectsList = ingredient.Effects;
                effectsList.Clear();
                if (value != null)
                {
        ...
        {
            if (record is IIngredientGetter ingredient)
            {
