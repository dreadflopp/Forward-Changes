...
{
    public class EffectShaderFillTexturePropertyHandler : AbstractPropertyHandler<AssetLinkGetter<SkyrimTextureAssetType>>
    {
        ...
        public override void SetValue(IMajorRecord record, AssetLinkGetter<SkyrimTextureAssetType>? value)
        {
            if (record is IEffectShader effectShader)
            {
                ...
                {
                    effectShader.FillTexture = new AssetLink<SkyrimTextureAssetType>(value.ToString());
                }
                else
                {
