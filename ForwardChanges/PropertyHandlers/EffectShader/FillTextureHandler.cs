...
{
    public class FillTextureHandler : AbstractPropertyHandler<AssetLinkGetter<SkyrimTextureAssetType>>
    {
        public override string PropertyName => "FillTexture";
        ...
        public override void SetValue(IMajorRecord record, AssetLinkGetter<SkyrimTextureAssetType>? value)
        {
            ...
            if (effectShader != null)
            {
                ...
                {
                    effectShader.FillTexture = new AssetLink<SkyrimTextureAssetType>(EffectShaderTexturePathHelper.Normalize(value));
                }
                else
                {
                    effectShader.FillTexture = null;
                }
            }
        }
        ...
        public override AssetLinkGetter<SkyrimTextureAssetType>? GetValue(IMajorRecordGetter record)
        {
            ...
            if (effectShader != null)
            {
                return effectShader.FillTexture;
            }
            return null;
        }
