...
{
    public class OcclusionPlaneHandler : AbstractPropertyHandler<IBoundingGetter?>
    {
        public override string PropertyName => "OcclusionPlane";
        ...
        public override void SetValue(IMajorRecord record, IBoundingGetter? value)
        {
            if (record is IPlacedObject placedObjectRecord)
            {
                if (value != null)
                {
                    ...
                    placedObjectRecord.OcclusionPlane = newBounding;
                }
                else
                {
                    placedObjectRecord.OcclusionPlane = null;
                }
            }
        }
        ...
        public override IBoundingGetter? GetValue(IMajorRecordGetter record)
        {
            ...
            {
                return placedObjectRecord.OcclusionPlane;
            }
