...
{
    public class CriticalUnused3Handler : AbstractPropertyHandler<int>
    {
        public override string PropertyName => "CriticalUnused3";
        ...
        public override int GetValue(IMajorRecordGetter record)
        {
            ...
            if (weapon != null && weapon.Critical != null)
            {
                return weapon.Critical.Unused3;
            }
            return 0;
        }
    }
