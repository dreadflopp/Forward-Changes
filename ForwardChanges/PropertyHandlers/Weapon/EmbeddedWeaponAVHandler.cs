...
{
    public class EmbeddedWeaponAVHandler : AbstractPropertyHandler<byte>
    {
        public override string PropertyName => "EmbeddedWeaponAV";
        ...
        public override void SetValue(IMajorRecord record, byte value)
        {
            ...
            {
                weapon.Data.EmbeddedWeaponAV = value;
            }
        }
        ...
        public override byte GetValue(IMajorRecordGetter record)
        {
            ...
            if (weapon != null && weapon.Data != null)
            {
                return weapon.Data.EmbeddedWeaponAV;
            }
            return 0;
        }
    }
