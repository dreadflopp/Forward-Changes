...
{
    public class FactionFollowerWaitMarkerPropertyHandler : AbstractPropertyHandler<IFormLinkNullable<IPlacedObjectGetter>>
    {
        ...
        public override IFormLinkNullable<IPlacedObjectGetter>? GetValue(IMajorRecordGetter record)
        {
            ...
            {
                return factionRecord.FollowerWaitMarker as IFormLinkNullable<IPlacedObjectGetter>;
            }
        ...
        public override void SetValue(IMajorRecord record, IFormLinkNullable<IPlacedObjectGetter>? value)
        {
            ...
            {
                factionRecord.FollowerWaitMarker = value ?? new FormLinkNullable<IPlacedObjectGetter>();
            }
            else
            {
