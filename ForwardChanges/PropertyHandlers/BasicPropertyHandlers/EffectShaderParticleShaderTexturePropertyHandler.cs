...
{
    public class EffectShaderParticleShaderTexturePropertyHandler : AbstractPropertyHandler<AssetLinkGetter<SkyrimTextureAssetType>>
    {
        ...
        public override void SetValue(IMajorRecord record, AssetLinkGetter<SkyrimTextureAssetType>? value)
        {
            if (record is IEffectShader effectShader)
            {
                ...
                {
                    effectShader.ParticleShaderTexture = new AssetLink<SkyrimTextureAssetType>(value.ToString());
                }
                else
                {
