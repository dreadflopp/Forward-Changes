...
namespace DreadsMashedPatch.PropertyHandlers.Spell
{
    public class FlagsHandler : AbstractFlagPropertyHandler<SpellDataFlag>
    {
        ...
        {
            return Enum.GetValues<SpellDataFlag>();
        }
