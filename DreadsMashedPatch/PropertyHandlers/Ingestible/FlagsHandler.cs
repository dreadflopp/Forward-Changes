...
{
    public class FlagsHandler : AbstractFlagPropertyHandler<Mutagen.Bethesda.Skyrim.Ingestible.Flag>
    {
        ...
        {
            return Enum.GetValues<Mutagen.Bethesda.Skyrim.Ingestible.Flag>();
        }
