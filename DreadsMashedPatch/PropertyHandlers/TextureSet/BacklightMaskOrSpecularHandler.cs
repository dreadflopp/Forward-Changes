...
{
    public class BacklightMaskOrSpecularHandler : AbstractPropertyHandler<AssetLinkGetter<SkyrimTextureAssetType>?>
    {
        public override string PropertyName => "BacklightMaskOrSpecular";
        ...
        public override void SetValue(IMajorRecord record, AssetLinkGetter<SkyrimTextureAssetType>? value)
        {
            ...
            if (tx != null)
                tx.BacklightMaskOrSpecular = value == null ? null : new AssetLink<SkyrimTextureAssetType>(DreadsMashedPatch.PropertyHandlers.General.TexturePathHelper.Normalize(value));
        }
        ...
        public override AssetLinkGetter<SkyrimTextureAssetType>? GetValue(IMajorRecordGetter record)
        {
            ...
            return tx?.BacklightMaskOrSpecular;
        }
